        ...
        <div className="max-w-screen-2xl mx-auto">
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-content flex flex-col">
                    <div className="w-full sm:pr-10 z-40 border-b border-base-200 backdrop-blur-xl navbar sticky top-0">
                    ...
                    <footer className="footer footer-center pt-0.5 p-10">
                        <aside>
                            <p>made with <a href="https://react.dev/" className="link link-hover">React</a>, <a href="https://tailwindcss.com" className="link link-hover">TailwindCSS</a> and <a href="https://daisyui.com/" className="link link-hover">DaisyUI</a>
                            </p>
                        </aside>
                    </footer>
                </div>
                <div className="drawer-side">
                    ...
                    <ul className="menu px-4 py-0 w-80 min-h-full bg-base-200 lg:bg-base-100">
